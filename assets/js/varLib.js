...
export const dropdownSubList = document.querySelectorAll('.dropdown-list>ul>li>div');
export const subNavAnchor = document.querySelectorAll('#nav-mobile div.sub-nav > a');
export const ulSubNav = document.querySelectorAll('#nav-mobile ul.sub-nav');
